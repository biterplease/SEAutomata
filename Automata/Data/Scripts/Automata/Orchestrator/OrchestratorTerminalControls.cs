...
{
    public class OrchestratorTerminalControls
    {
        public static ServerConfig.OrchestratorBlockConfig BlockConfig = ServerConfig.Instance.OrchestratorServerSettings;
        ...
        /// <returns></returns>
        private static OrchestratorBlock GetBlock(IMyTerminalBlock block)
        {
            if (block != null && block.GameLogic != null) return block.GameLogic.GetAs<OrchestratorBlock>();
            return null;
        }
        ...
        static bool CustomVisibleCondition(IMyTerminalBlock b)
        {
            ...
            return b?.GameLogic?.GetAs<OrchestratorBlock>() != null;
        }
        /// <summary>
